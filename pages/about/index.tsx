  ...
  return (
    <>
      ...
      <TitleAndText>
        ...
        <p>
          Em 2016 pela{" "}
          <a href="https://survey.stackoverflow.co/2022/" target={"_blank"}>
            Stack Overflow
          </a>{" "}
          na categoria de IDE mais utilizada, o Visual Studio Code ficou em 13°
          lugar, com apenas 7,2% dos 47.000 entrevistados. Em 2018, o VS Code
          ficou em primeiro lugar, com 35% dos mais de 100.000 entrevistados. Na
          pesquisa de 2019, também ficou em primeiro com 50% dos quase 90.000
          entrevistados. Na pesquisa de 2022, o VS Code subiu ainda mais sua
          porcentagem chegando a 74,48% das 71.010 entrevistados.
        </p>
      </TitleAndText>
      <ImgCard>
        <img
      ...
      <TitleAndText>
        <div id="annotation">
          <p>
            Desde 2011 todos os anos o{" "}
            <a href="https://stackoverflow.com/" target={"_blank"}>
              Stack Overflow
            </a>{" "}
            faz uma pesquisa com desenvolvedores para saber as principais
            informações sobre essa área, como qual a IDE mais utilizada, quanta
            cafeína é consumida, qual o salario por linguagem de programação,
            entre outros.{" "}
          </p>
        </div>
      </TitleAndText>
