    ...
    <StyledReasons>
      ...
      <div className="card_reasons">
        ...
        <p>
          ...
          <span className="text_general">
            Os ciclos de construção, edição e depuração ocorrem suavemente sem
            perder mais tempo mexendo no ambiente do que executando suas ideias.
          </span>
        </p>
      </div>
      <div className="card_reasons">
        ...
        <p>
          ...
          <span className="text_general">
            ...
            fácil personalização. Todas essas características tornam o seu
            trabalho instantaneamente mais produtivo.
          </span>
        </p>
      </div>
      <div className="card_reasons">
      ...
      <div className="card_reasons">
        <div className="card_title">
          <div className="bg_img">
            <img src="img/Home/start-coding-icon.png" alt="ícone velocidade" />
          </div>
          <h3>Start coding</h3>
        </div>
        <p className="text_main">
          Se você valoriza a ferramenta de desenvolvimento centrada no editor de
          código, e estiver criando aplicativos de nuvem e Web multiplataforma,
